...
def round_one(cmd):
    ...
    games = [
        ...
        (288, 192, 142342898, 90, 130),
         ...
         (384, 256, 1170105035, 85, 115),
         (384, 256, 1360544799, 85, 115),
         (384, 256, 234785527, 85, 115),
         (384, 256, 205897768, 85, 115),
         (384, 256, 1325939940, 85, 115),
         (384, 256, 248792245, 85, 115),
    ]

    max_score    = 0.99                    # Round score
