...
auto Replay::output_header(nlohmann::json& replay) -> void {
    ...
    replay["free_planets"]      = free_planets;
    replay["occupied_planets"]  = occupied_planets;
    replay["destroyed_planets"] = destroyed_planets;
    replay["self-collisions"]   = self_collisions;
}
