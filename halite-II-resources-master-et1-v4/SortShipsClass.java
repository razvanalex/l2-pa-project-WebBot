...
public class SortShipsClass {
	...
	static List<Ship> sortShips(List<Ship>ships,List<Planet>planets){
		final class MyEntry implements Map.Entry<Ship,Planet> {
    	...
    	class ComparatorSP implements Comparator<MyEntry>{	
    	...
    	List<Ship>new_ships=new LinkedList<Ship>();
