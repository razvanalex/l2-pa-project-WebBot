...
//    TCLAP::SwitchArg singlePlayerSwitch(
//        "",
//        "single-player",
...
//    );
    ...
    TCLAP::SwitchArg silentSwitch("z",
                                  "super_silent",
                                  "Don't print stats to the console at the end of a game.",
                                  cmd,
                                  false);
...
//    bool single_player  = singlePlayerSwitch.getValue();
    ...
    if (unlabeledArgs.size() == 1 && n_players_for_map_creation != 2 &&
        n_players_for_map_creation != 4 && n_players_for_map_creation != 1) {
