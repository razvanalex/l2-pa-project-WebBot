...
public class Ship extends Entity {
    ...
    public enum Mod {Attack, Defence}
    ...
    public double getRealDistanceTo(GameMap gameMap, Entity planet) {
    ...
    public static double navigateShipToPlanet(
        ...
        dist += 4 * (nextPosition.getDistanceTo(initial) + nextPosition.getDistanceTo(targetPos) - initial.getDistanceTo(targetPos));
