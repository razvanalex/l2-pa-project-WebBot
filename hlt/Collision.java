...
public class Collision {
    ...
    public static boolean isInBoundingCircle(Position point, final Entity circle, 
            final double fudge) {

        final double circleRadius = circle.getRadius();
        final double distance = point.getDistanceTo(circle);
        
        return circleRadius + fudge <= distance;
    }
}
