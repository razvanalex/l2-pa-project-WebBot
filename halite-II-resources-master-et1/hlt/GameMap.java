...
public class GameMap {
    ...
    private static void addEntitiesBetween(final List<Entity> entitiesFound,
        ...
        for (final Entity entity : entitiesToCheck) {
            ...
            if (entity instanceof Ship &&Collision.segmentCircleIntersect(start, target, entity, Constants.MAX_SPEED*1/3))
            	entitiesFound.add(entity);
            else if (Collision.segmentCircleIntersect(start, target, entity, Constants.FORECAST_FUDGE_FACTOR)) {
                entitiesFound.add(entity);
            }
        }
    }
